...
import { FactoryComponent } from 'app/entities/factory/factory.component';
import { FactoryService } from 'app/entities/factory/factory.service';
import { Factory } from 'app/shared/model/factory.model';

describe('Component Tests', () => {
  describe('Factory Management Component', () => {
    let comp: FactoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FactoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.factories && comp.factories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
