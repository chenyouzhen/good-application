...
import { KpiDeleteDialogComponent } from 'app/entities/kpi/kpi-delete-dialog.component';
import { KpiService } from 'app/entities/kpi/kpi.service';

describe('Component Tests', () => {
  describe('Kpi Management Delete Component', () => {
    let comp: KpiDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(KpiDeleteDialogComponent, '')
        .compileComponents();
