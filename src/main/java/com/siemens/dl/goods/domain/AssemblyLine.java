...
public class AssemblyLine implements Serializable {
    ...
    public AssemblyLine mappings(Set<Mapping> mappings) {
        this.mappings = mappings;
        return this;
    }

    public AssemblyLine addMapping(Mapping mapping) {
        this.mappings.add(mapping);
        mapping.setAssemblyLine(this);
        return this;
    }

    public AssemblyLine removeMapping(Mapping mapping) {
        this.mappings.remove(mapping);
        mapping.setAssemblyLine(null);
        return this;
    }
